...
echo "=== C2CAM: STEP 3 - CONFIGURING OPTIMIZED 720P STREAM (15 FPS DROP) ==="
cat << 'CGF' > /root/go2rtc.yaml
streams:
  c2cam: exec:ffmpeg -loglevel quiet -f v4l2 -input_format mjpeg -video_size 1280x720 -i /dev/video2 -r 15 -c:v copy -f mpjpeg -
...
echo "Stream is active on port 8081 at 720p / 15 FPS!"
EOF
